    ...
    <div class="container-lg my-3">
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
              ...
              <div class="carousel-item">
                  <img src="pictures/Emerald_City.jpg" class="d-block w-100" alt="Slide 3">
                  <div class="carousel-caption d-none d-md-block">
  ...
  <div class="row row-cols-1 row-cols-md-3">
    <div class="col mb-4">
      <div class="card h-100">
        <img src="pictures/Emerald_City.jpg" aria-hidden="true" class="card-img-top" alt="Emerald city">
        <div class="card-body">
    ...
    <div class="col mb-4">
      <div class="card h-100">
        <img src="pictures/Market_Clock.jpg" class="card-img-top" alt="Market Clock">
        <div class="card-body">
